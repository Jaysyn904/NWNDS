//::///////////////////////////////////////////////
//:: Name: OnDeath_Sarrick
//:: Copyright (c) 2012 Athas Reborn
//:://////////////////////////////////////////////
/*
    Sarrick the Theif's OnDeath script
*/
//:://////////////////////////////////////////////
...
string sTagTarget = GetLocalString(oPC, "KILL_TASK_TARGET");
{
    if(GetIsPC(GetLastKiller()) &&
       GetLocalInt(GetLastKiller(),"NW_JOURNAL_ENTRY"  + "TheTemplars") == 8)
    {
 AddJournalQuestEntry ("TheTemplars", 9, oPC);
    }
}
aSetPLocalInt(GetLastKiller(), "nKilledThugs", 1);
    SpeakString("Damn you templar lackies! Argh!!", TALKVOLUME_TALK);
