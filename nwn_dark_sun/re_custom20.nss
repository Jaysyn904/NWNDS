...
Athas Reborn
Table 20 - The Great Alluvial Sand Wastes - Blood Sands - Mastyrial Lair

Areas Used in:
The Great Alluvial Sand Wastes - Blood Sands - Mastyrial Lair
...
/*      case 0:sChoice = "tarek_001"; // Creature ResRef goes between the " marks.
        ...
        break;
*/
        case 0:sChoice = "blkmastyrial_001"; // Mastyrial, Black
        fCR = 7.0;
        iMinNum = 5;
        iMaxNum = 20;
        iWeight = 8;
        ...
        case 1:sChoice = "blkmastyrial_002"; // Mastyrial, Black - Medium
        fCR = 8.0;
        iMinNum = 2;
        iMaxNum = 10;
        iWeight = 4;
