...
void main()
{
   ...
   effect eGrabDmg1 = EffectDamage(d10(1)+nCreSTR, DAMAGE_TYPE_BLUDGEONING);
   effect eGrabDmg2 = EffectDamage(d8(1)+nCreSTR, DAMAGE_TYPE_PIERCING);
   int nSTR_Target;
   int nSTR_Creature;
...
// Deal 1d10 bludgeoning damage + 1d8 piercing damage.
...
// If the target wins, send a short message to it and return.
      ...
      {
         FloatingTextStringOnCreature("You escape the neo-otyugh's grapple.", oTarget);
         return;
      }
...
// entangled.
      ...
      {
         FloatingTextStringOnCreature("The neo-otyugh tries to constrict you!", oTarget);
      }
      else
      {
         FloatingTextStringOnCreature("The neo-otyugh is constricting you!", oTarget);
      }
