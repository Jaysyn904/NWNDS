...
//:: AR_ClimbDown02
//::
//:: Abandoned Home to UnderTyr Passage (3)
//::
//::
//::
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
object oFall=GetNearestObjectByTag ("WP_Passage3");//the object that stores the fall location, set manually by the builder
...
//during a transition between areas.
    if (sDirection == "UP")//If the placeable is a climb UP placeable
        {
        oDestination=GetObjectByTag ("WP_FromPassage3");//get the climb up waypoint
        }
    else if (sDirection == "DOWN")//if the placeable is a climb DOWN placeable
        {
        oDestination=GetObjectByTag ("WP_Passage3");//Get the climb down waypoint
        }
