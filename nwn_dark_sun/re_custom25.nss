...
*/
        ...
        case 0:sChoice = "ar_altguard_001"; // Altaruk Guard
        fCR = 8.0;
        iMinNum = 0;
        iMaxNum = 0;
        iWeight = 16;
        ...
        case 1:sChoice = "ar_altguard_002"; // Altaruk Guard
        fCR = 16.0;
        iMinNum = 0;
        iMaxNum = 0;
        iWeight = 16;
        ...
        case 2:sChoice = "ar_altguard_003"; // Altaruk Guard
        fCR = 23.0;
        iMinNum = 0;
        iMaxNum = 0;
        iWeight = 16;
        ...
        case 3:sChoice = "ar_altguard_004"; // Altaruk Guard
        fCR = 32.0;
        iMinNum = 0;
        iMaxNum = 0;
        iWeight = 16;
