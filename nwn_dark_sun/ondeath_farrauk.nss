//::///////////////////////////////////////////////
//:: Name: OnDeath_Farrauk
//:: Copyright (c) 2012 Athas Reborn
//:://////////////////////////////////////////////
/*
    Farrauk's OnDeath script
*/
//:://////////////////////////////////////////////
...
PartyGold(oPC);
{
    if(GetIsPC(GetLastKiller()) &&
       GetLocalInt(GetLastKiller(),"NW_JOURNAL_ENTRY"  + "LostSouls") == 5)
    {
 AddJournalQuestEntry ("LostSouls", 6, oPC);
 CreateItemOnObject("QST_FARRAUKSOUL", oPC);
    }
}
aSetPLocalInt(GetLastKiller(), "nKilledDruid", 1);
    SpeakString("The forest will eat you alive meat sack!", TALKVOLUME_TALK);
