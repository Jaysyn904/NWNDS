// Bog Wader Improved Grab & Constrict - Item Unique OnHit Script
//
...
void main()
{
   ...
   effect eGrabDmg1 = EffectDamage(d4(1)+4, DAMAGE_TYPE_PIERCING && DAMAGE_TYPE_BLUDGEONING);
   int nSTR_Target;
   int nSTR_Creature;
...
// Deal 1d4+4 piercing &/or crushing damage.
...
// If the target wins, send a short message to it and return.
      ...
      {
         FloatingTextStringOnCreature("You escape the bog wader's grapple.", oTarget);
         return;
      }
...
// entangled.
      ...
      {
         FloatingTextStringOnCreature("The bog wader tries to grapple you!", oTarget);
      }
      else
      {
         FloatingTextStringOnCreature("The bog wader is grappling you!", oTarget);
      }
