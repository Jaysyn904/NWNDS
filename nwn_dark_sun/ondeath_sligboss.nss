//::///////////////////////////////////////////////
//:: Name: OnDeath_SligBoss
//:: Copyright (c) 2012 Athas Reborn
//:://////////////////////////////////////////////
/*
    The Slig Warrior's OnDeath script
*/
//:://////////////////////////////////////////////
...
PartyGold(oPC);
{
    if(GetIsPC(GetLastKiller()) &&
       GetLocalInt(GetLastKiller(),"NW_JOURNAL_ENTRY"  + "rottedparchment") == 1)
    {
 AddJournalQuestEntry ("rottedparchment", 2, oPC);
    }
}
aSetPLocalInt(GetLastKiller(), "nKilledThugs", 1);
    SpeakString("Argrgrgrhgh!", TALKVOLUME_TALK);
