//:: Scorpion Grab 03 - Item Unique OnHit Script
//::
//:: This attack is for the Gargantuan Monsterous Scorpion.
//::
//::
...
void main()
{
   ...
   effect eGrabDmg = EffectDamage(d6(2)+nCreSTR, DAMAGE_TYPE_SLASHING);
   int nSTR_Target;
   int nSTR_Creature;
