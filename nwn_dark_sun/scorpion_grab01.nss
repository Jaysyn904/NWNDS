//:: Scorpion Grab 01 - Item Unique OnHit Script
//::
//:: This attack is for the Large Monsterous Scorpion.
//::
//::
...
void main()
{
   ...
   effect eGrabDmg = EffectDamage(d6(1)+nCreSTR, DAMAGE_TYPE_SLASHING);
   int nSTR_Target;
   int nSTR_Creature;
