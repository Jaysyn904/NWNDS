//::///////////////////////////////////////////////
//:: Name: OnDeath_Martosa
//:: Copyright (c) 2012 Athas Reborn
//:://////////////////////////////////////////////
/*
    Martosa's OnDeath script
*/
//:://////////////////////////////////////////////
...
string sTagTarget = GetLocalString(oPC, "KILL_TASK_TARGET");
{
    if(GetIsPC(GetLastKiller()) &&
       GetLocalInt(GetLastKiller(),"NW_JOURNAL_ENTRY"  + "TheDraqomen") == 3)
    {
 AddJournalQuestEntry ("TheDraqomen", 4, oPC);
    }
}
aSetPLocalInt(GetLastKiller(), "nKilledThugs", 1);
    SpeakString("Damn that bitch Selene! Argh!", TALKVOLUME_TALK);
