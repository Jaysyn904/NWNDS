...
// Deal 2d6+STR Modifier bludgeoning damage & 1d6 Fire Damage
...
// entangled.
      ...
      {
         FloatingTextStringOnCreature("The salamander tries to constrict you!", oTarget);
      }
      else
      {
         FloatingTextStringOnCreature("The salamander is constricting you!", oTarget);
      }
// Apply the Entangle effect no matter whether the target is immune or not. If
// it is, it will have already received an according message that the Black
// Mastyrial entangle attempt failed. Otherwise it simply gets entangled as
// intended.
