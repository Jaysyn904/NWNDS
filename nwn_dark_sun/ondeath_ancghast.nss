//::///////////////////////////////////////////////
//:: Name: OnDeath_AncGhast
//:: Copyright (c) 2012 Athas Reborn
//:://////////////////////////////////////////////
/*
    The Ancient Ghast's OnDeath script
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    PartyGold(oPC);  //Mindless undead = no ceramic.
    AddJournalQuestEntry ("DeadsRevenge", 2, oPC);
    AddJournalQuestEntry ("rottedparchment", 1, oPC);
