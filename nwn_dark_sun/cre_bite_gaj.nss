// Gaj Improved Grab - Item Unique OnHit Script
//
...
void main()
{
   ...
   effect eGrabDmg1 = EffectDamage(d6(1)+nCreSTR, DAMAGE_TYPE_BLUDGEONING);
   effect eGrabDmg2 = EffectDamage(d6(1)+nCreSTR, DAMAGE_TYPE_PIERCING);
   int nSTR_Target;
   int nSTR_Creature;
...
// Deal 1d6 bludgeoning damage + 1d6 piercing damage.
      ApplyEffectToObject(DURATION_TYPE_INSTANT, eGrabDmg1, oTarget);
      ApplyEffectToObject(DURATION_TYPE_INSTANT, eGrabDmg2, oTarget);
...
// If the target wins, send a short message to it and return.
      ...
      {
         FloatingTextStringOnCreature("You escape the gaj's grapple.", oTarget);
         return;
      }
...
// entangled.
      ...
      {
         FloatingTextStringOnCreature("The gaj tries to grapple you!", oTarget);
      }
      else
      {
         FloatingTextStringOnCreature("The gaj is grappling you!", oTarget);
      }
