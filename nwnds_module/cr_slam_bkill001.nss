...
// the two results are NOT identical.
      do
      {
         ...
         nSTR_Creature = 8 + GetAbilityScore(oPC, ABILITY_STRENGTH) + d20();  //  Blossomkillers have a +8 to grapple checks.
      }
...
// entangled.
      ...
      {
         FloatingTextStringOnCreature("The blossomkiller tries to constrict you!", oTarget);
      }
      else
      {
         FloatingTextStringOnCreature("The blossomkiller is constricting you!", oTarget);
      }
