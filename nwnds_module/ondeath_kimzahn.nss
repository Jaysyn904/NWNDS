//::///////////////////////////////////////////////
//:: Name: OnDeath_Kimzahn
//:: Copyright (c) 2012 Athas Reborn
//:://////////////////////////////////////////////
/*
    Kimzahn's OnDeath script
*/
//:://////////////////////////////////////////////
...
PartyGold(oPC);
{
    if(GetIsPC(GetLastKiller()) &&
       GetLocalInt(GetLastKiller(),"NW_JOURNAL_ENTRY"  + "ds_hermitquest") == 2)
    {
 AddJournalQuestEntry ("ds_hermitquest", 3, oPC);
    }
}
    SpeakString("Y-you, The flames shall consume you!...", TALKVOLUME_TALK);
