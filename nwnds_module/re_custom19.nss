...
Athas Reborn
Table 19 - The Great Alluvial Sand Wastes - Blood Sands

Areas Used in:
The Great Alluvial Sand Wastes - Blood Sands
...
*/
        ...
        case 4:sChoice = "elvenraider001"; // Elven Raider
        fCR = 10.0;
        iMinNum = 2;
        iMaxNum = 3;
        iWeight = 4;
        ...
        case 5:sChoice = "blkmastyrial_001"; // Mastyrial, Black
        fCR = 8.0;
        iMinNum = 5;
        iMaxNum = 15;
        iWeight = 8;
        ...
        case 7:sChoice = "elem_fire_sm001"; // [AR] Fire Elemental, Small
        fCR = 3.0;
        iMinNum = 1;
        iMaxNum = 1;
        iWeight = 4;
        ...
        case 8:sChoice = "elem_fire_md001"; // [AR] Fire Elemental, Medium
        fCR = 5.0;
        iMinNum = 1;
        iMaxNum = 1;
        iWeight = 4;
