...
/*
    ...
    If you set a integer on the creature named
...
void main()
{
    ...
    effect eFx1 = EffectVisualEffect(VFX_DUR_MAGICAL_SIGHT);
    effect eFx2 = EffectUltravision();
    effect eFx3 = EffectSeeInvisible();

    ApplyEffectToObject(DURATION_TYPE_PERMANENT,eFx1,OBJECT_SELF);
    ApplyEffectToObject(DURATION_TYPE_PERMANENT,eFx2,OBJECT_SELF);
    ApplyEffectToObject(DURATION_TYPE_PERMANENT,eFx3,OBJECT_SELF);
