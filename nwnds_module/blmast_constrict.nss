...
// Deal 1d4+STR Modifier bludgeoning damage.
...
// entangled.
      ...
      {
         FloatingTextStringOnCreature("The black mastyrial tries to constrict you!", oTarget);
      }
      else
      {
         FloatingTextStringOnCreature("The black mastyrial is constricting you!", oTarget);
      }
