//:: Scorpion Grab 02 - Item Unique OnHit Script
//::
//:: This attack is for the Huge Monsterous Scorpion.
//::
//::
...
void main()
{
   ...
   effect eGrabDmg = EffectDamage(d8(1)+nCreSTR, DAMAGE_TYPE_SLASHING);
   int nSTR_Target;
   int nSTR_Creature;
