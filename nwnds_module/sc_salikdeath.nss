...
PartyGold(oPC);
    if(GetIsPC(GetLastKiller()) &&
       GetLocalInt(GetLastKiller(),"NW_JOURNAL_ENTRY"  + "jt_unearthed") == 1)
    {
 AddJournalQuestEntry ("jt_unearthed", 2, oPC);
    }
    SpeakString("N-no...this...wasn't supposed to...h-happen...", TALKVOLUME_TALK);
