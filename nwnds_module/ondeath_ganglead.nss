//::///////////////////////////////////////////////
//:: Name: OnDeath_GangLead
//:: Copyright (c) 2012 Athas Reborn
//:://////////////////////////////////////////////
/*
    The Gang Leader's OnDeath script
*/
//:://////////////////////////////////////////////
...
PartyGold(oPC);
{
    if(GetIsPC(GetLastKiller()) &&
       GetLocalInt(GetLastKiller(),"NW_JOURNAL_ENTRY"  + "TheTemplars") == 3)
    {
 AddJournalQuestEntry ("TheTemplars", 4, oPC);
    }
}
aSetPLocalInt(GetLastKiller(), "nKilledThugs", 1);
    SpeakString("Damn all templar lackies! Argh!", TALKVOLUME_TALK);
