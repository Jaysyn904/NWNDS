...
// :: 2009.07.25 civious / tsunami282 - correct language name parsing for .lang command
    ...
    else if (GetStringLeft(sCom, 4) == ".lan") //sets the language of the target
    {
        ...
        else if (FindSubString(sArgsLC, "halfling") != -1)
        {
            iLang = 3;
            sLang = "Halfling";
        }
        else if (FindSubString(sArgsLC, "dwar") != -1)
        {
            iLang = 4;
            sLang = "Dwarven";
        }
        else if (FindSubString(sArgsLC, "orc") != -1)
        {
            iLang = 5;
            sLang = "Orc";
        }
        else if (FindSubString(sArgsLC, "goblin") != -1)
        {
            iLang = 6;
            sLang = "Goblin";
        }
        else if (FindSubString(sArgsLC, "draconic") != -1)
        {
            iLang = 7;
            sLang = "Draconic";
        }
        else if (FindSubString(sArgsLC, "animal") != -1)
        {
            iLang = 8;
            sLang = "Animal";
        }
        else if (FindSubString(sArgsLC, "cant") != -1)
        {
            iLang = 9;
            sLang = "Thieves' Cant";
        }
        else if (FindSubString(sArgsLC, "celestial") != -1)
        {
            iLang = 10;
            sLang = "Celestial";
        }
        else if (FindSubString(sArgsLC, "abyssal") != -1)
        {
            iLang = 11;
            sLang = "Abyssal";
        }
        else if (FindSubString(sArgsLC, "infernal") != -1)
        {
            iLang = 12;
            sLang = "Infernal";
        }
        else if (FindSubString(sArgsLC, "drow") != -1)
        {
            iLang = 13;
            sLang = "Drow";
        }
        else if (FindSubString(sArgsLC, "sylvan") != -1)
        {
            iLang = 14;
            sLang = "Sylvan";
        }
        else if (FindSubString(sArgsLC, "rashemi") != -1)
        {
            iLang = 15;
            sLang = "Rashemi";
        }
        else if (FindSubString(sArgsLC, "mulhorandi") != -1)
        {
            iLang = 16;
            sLang = "Mulhorandi";
        }
