...
/*      case 0:sChoice = "tarek_001"; // Creature ResRef goes between the " marks.
        ...
        break;
*/
        case 0:sChoice = "pridemane001"; // Pridemane
        fCR = 14.0;
        iMinNum = 0;
        iMaxNum = 0;
        iWeight = 8;
		...
		case 1:sChoice = "pridemane002"; // Pridemane, Ranger
        fCR = 26.0;
        iMinNum = 0;
        iMaxNum = 0;
        iWeight = 2;
		...
		case 2:sChoice = "pridemane003"; // Pridemane, Barbarian
        fCR = 24.0;
        iMinNum = 0;
        iMaxNum = 0;
        iWeight = 4;
		...
		case 3:sChoice = "ar_kreen_003"; // Thri-kreen, Druid
        fCR = 13.0;
        iMinNum = 0;
        iMaxNum = 0;
        iWeight = 4;
		...
		case 4:sChoice = "ar_kreen_002"; // Thri-kreen, Ranger
        fCR = 12.0;
        iMinNum = 0;
        iMaxNum = 0;
        iWeight = 4;
        ...
        case 5:sChoice = "bulette"; // Bulette
        fCR = 10.0;
        iMinNum = 0;
        iMaxNum = 0;
        iWeight = 8;
        ...
        case 6:sChoice = "ar_chimera001"; // Chimera [AR]
        fCR = 10.0;
        iMinNum = 0;
        iMaxNum = 0;
        iWeight = 8;
        ...
        case 7:sChoice = "ar_dragonne001"; // Dragonne
        fCR = 8.0;
        iMinNum = 0;
        iMaxNum = 0;
        iWeight = 8;
