//::///////////////////////////////////////////////
//:: Name: OnDeath_HejBrute
//:: Copyright (c) 2012 Athas Reborn
//:://////////////////////////////////////////////
/*
    The Hej-Kin Brute's OnDeath script
*/
//:://////////////////////////////////////////////
...
PartyGold(oPC);
{
    if(GetIsPC(GetLastKiller()) &&
       GetLocalInt(GetLastKiller(),"NW_JOURNAL_ENTRY"  + "HejkinRaiders") == 1)
    {
 AddJournalQuestEntry ("HejkinRaiders", 2, oPC);
    }
}
aSetPLocalInt(GetLastKiller(), "nKilledhejkin", 1);
    SpeakString("*You recover the stolen Iron Shipment*", TALKVOLUME_TALK);
...
CreateItemOnObject("QST_STOLENIRON", oPC);
