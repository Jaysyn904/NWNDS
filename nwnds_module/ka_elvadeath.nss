...
PartyGold(oPC);
{
    if(GetIsPC(GetLastKiller()) &&
       GetLocalInt(GetLastKiller(),"NW_JOURNAL_ENTRY"  + "Clockwork") == 3)
    {
 AddJournalQuestEntry ("Clockwork", 4, oPC);
    }
}
aSetPLocalInt(GetLastKiller(), "nKilledElva", 1);
    SpeakString("Damn you!", TALKVOLUME_TALK);
