...
//:://////////////////////////////////////////////
/*
    Portek the Banshee's OnDeath script
*/
//:://////////////////////////////////////////////
...
string sTagTarget = GetLocalString(oPC, "KILL_TASK_TARGET");
{
    if(GetIsPC(GetLastKiller()) &&
       GetLocalInt(GetLastKiller(),"NW_JOURNAL_ENTRY"  + "LostSouls") == 1)
    {
 AddJournalQuestEntry ("LostSouls", 2, oPC);
 CreateItemOnObject("qst_porteksoul", oPC);
    }
}
aSetPLocalInt(GetLastKiller(), "nKilledDruid", 1);
    SpeakString("Noooo... my booze!", TALKVOLUME_TALK);
