/************************ [On Death] *******************************************
    Filename: death_neootyugh.nss
************************* [On Death] *******************************************
	For Clockwork Isle mini-boss.
...
PartyGold(oPC);
{
    if(GetIsPC(GetLastKiller()) &&
       GetLocalInt(GetLastKiller(),"NW_JOURNAL_ENTRY"  + "Clockwork") == 7)
    {
 AddJournalQuestEntry ("Clockwork", 8, oPC);
    }
}
SetLocalInt(GetLastKiller(), "nKilledOtyugh", 1);
    SpeakString("Hisss!", TALKVOLUME_TALK);
