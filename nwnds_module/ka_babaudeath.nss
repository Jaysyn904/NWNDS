...
void main()
    {
        ...
        // Give a 5% chance to drop armor &/or equipped weapon
        int bDroppableA = d100() > 95;
        int bDroppableW = d100() > 95;
...
PartyGold(oPC);
{
    if(GetIsPC(GetLastKiller()) &&
       GetLocalInt(GetLastKiller(),"NW_JOURNAL_ENTRY"  + "Clockwork") == 8)
    {
 AddJournalQuestEntry ("Clockwork", 9, oPC);
    }
}
SetLocalInt(GetLastKiller(), "nKilledBabau", 1);
    SpeakString("Rargh!", TALKVOLUME_TALK);
